...
public class TestStyles {
    ...
    private static final String html_output_less_external =
        "<!DOCTYPE html><html><head><title>TestApp html</title><style>#header{color:#6c94be}</style></head><body></body></html>";
    ...
    private static final String html_output_sass_external =
        "<!DOCTYPE html><html><head><title>TestApp html</title><style>h1{color:red;background-color:#00f;padding:.5em}</style></head><body></body></html>";
    ...
    public void compileExternalSass() throws IOException, InvalidInput {
        ...
        assertEquals(html_output_sass_external, output, "Invalid generated HTML");
    }
    ...
    public void compileInlineSass() throws IOException, InvalidInput {
        ...
        assertEquals(html_output_sass_inline, output, "Invalid generated HTML");
    }
    @Test
    ...
    private static final String html_output_stylus_external =
        "<!DOCTYPE html><html><head><title>TestApp html</title><style>body{font:14px/1.4 Helvetica,Arial,sans-serif}" +
