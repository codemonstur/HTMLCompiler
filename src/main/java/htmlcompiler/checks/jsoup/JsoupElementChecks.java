...
public enum JsoupElementChecks {;
    ...
    public interface JsoupElementCheck {
        void checkElement(Logger log, Path file, Element element);
    }

    public static void hasStyleAttribute(final Logger log, final Path file, final Element element) {
    ...
    public static void hasUppercaseTagsOrAttributes(final Logger log, final Path file, final Element element) {
    ...
    public static void missingAltForImages(final Logger log, final Path file, final Element element) {
    ...
    public static void missingPlaceholderForInputs(final Logger log, final Path file, final Element element) {
    ...
    public static void dontUseMarquee(final Logger log, final Path file, final Element element) {
        if ("marquee".equalsIgnoreCase(element.tagName()))
            log.warn("File " + file + " contains a marquee tag");
    }

    public static void dontUseBlink(final Logger log, final Path file, final Element element) {
        if ("blink".equalsIgnoreCase(element.tagName()))
            log.warn("File " + file + " contains a blink tag");
    }

    public static void dontUseBold(final Logger log, final Path file, final Element element) {
        if ("b".equalsIgnoreCase(element.tagName()))
            log.warn("File " + file + " contains a b tag, rewrite with strong");
    }

    public static void dontUseItalic(final Logger log, final Path file, final Element element) {
        if ("i".equalsIgnoreCase(element.tagName()))
            log.warn("File " + file + " contains an i tag, rewrite with em");
    }

    public static void dontUseStrong(final Logger log, final Path file, final Element element) {
        if ("strong".equalsIgnoreCase(element.tagName()))
            log.warn("File " + file + " contains a strong tag, rewrite with b");
    }

    public static void dontUseEm(final Logger log, final Path file, final Element element) {
        if ("em".equalsIgnoreCase(element.tagName()))
            log.warn("File " + file + " contains an em tag, rewrite with i");
    }

    public static void dontUseStyling(final Logger log, final Path file, final Element element) {
        if ("b".equalsIgnoreCase(element.tagName()))
    ...
    public static void marginWidthInBody(final Logger log, final Path file, final Element element) {
    ...
    public static void alignAttributeContainsAbsmiddle(final Logger log, final Path file, final Element element) {
        if ("absmiddle".equalsIgnoreCase(element.attr("align")))
            log.warn("File " + file + " has an align attribute with absmiddle as value");
    }

    public static void hasBorderAttribute(final Logger log, final Path file, final Element element) {
    ...
    public static void hasDeprecatedTag(final Logger log, final Path file, final Element element) {
    ...
    public static void hasDeprecatedAttribute(final Logger log, final Path file, final Element element) {
        for (final var attribute : element.attributes()) {
    ...
    public static void scriptWithHardcodedNonce(final Logger log, final Path file, final Element element) {
    ...
    public static void styleWithHardcodedNonce(final Logger log, final Path file, final Element element) {
    ...
    public static void labelWithForAttribute(final Logger log, final Path file, final Element element) {
    ...
    public static void inputWithoutMaxLength(final Logger log, final Path file, final Element element) {
    ...
    public static void hasEventHandlerAttribute(final Logger log, final Path file, final Element element) {
        for (final var attribute : element.attributes()) {
    ...
    public static void isValidTag(final Logger log, final Path file, final Element element) {
        if (!known_tags.contains(element.tagName().toLowerCase()))
            log.warn("File " + file + " contains an unknown tag " + element.tagName());
    }

    public static void isValidAttribute(final Logger log, final Path file, final Element element) {
        for (final var attribute : element.attributes()) {
