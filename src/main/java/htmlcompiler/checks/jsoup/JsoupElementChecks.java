...
public enum JsoupElementChecks {;
    ...
    public interface JsoupElementCheck {
        void checkElement(Logger log, Config config, Path file, Element element);
    }

    public static void buttonHasHref(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void hasStyleAttribute(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void hasUppercaseTagsOrAttributes(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void missingAltForImages(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void missingPlaceholderForInputs(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void missingInputType(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void unknownInputType(final Logger log, final Config config, final Path file, final Element element) {
        if (!"input".equals(element.tagName())) return;
        final var type = element.attr("type");
    ...
    public static void dontUseMarquee(final Logger log, final Config config, final Path file, final Element element) {
        if ("marquee".equalsIgnoreCase(element.tagName()))
            log.warn("File " + toRelativePath(file) + " contains a <marquee> tag");
    }

    public static void dontUseBlink(final Logger log, final Config config, final Path file, final Element element) {
        if ("blink".equalsIgnoreCase(element.tagName()))
            log.warn("File " + toRelativePath(file) + " contains a <blink> tag");
    }

    public static void dontUseBold(final Logger log, final Config config, final Path file, final Element element) {
        if ("b".equalsIgnoreCase(element.tagName()))
            log.warn("File " + toRelativePath(file) + " contains a <b> tag, rewrite with <strong>");
    }

    public static void dontUseItalic(final Logger log, final Config config, final Path file, final Element element) {
        if ("i".equalsIgnoreCase(element.tagName()))
            log.warn("File " + toRelativePath(file) + " contains an <i> tag, rewrite with <em>");
    }

    public static void dontUseStrong(final Logger log, final Config config, final Path file, final Element element) {
        if ("strong".equalsIgnoreCase(element.tagName()))
            log.warn("File " + toRelativePath(file) + " contains a <strong> tag, rewrite with <b>");
    }

    public static void dontUseEm(final Logger log, final Config config, final Path file, final Element element) {
        if ("em".equalsIgnoreCase(element.tagName()))
            log.warn("File " + toRelativePath(file) + " contains an <em> tag, rewrite with <i>");
    }

    public static void dontUseStyling(final Logger log, final Config config, final Path file, final Element element) {
        if ("b".equalsIgnoreCase(element.tagName()))
    ...
    public static void marginWidthInBody(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void alignAttributeContainsAbsmiddle(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void hasBorderAttribute(final Logger log, final Config config, final Path file, final Element element) {
        if (element.hasAttr("border"))
            log.warn("File " + toRelativePath(file) + " has a tag with a border attribute");
    }

    public static void hasDeprecatedTag(final Logger log, final Config config, final Path file, final Element element) {
        if (deprecated_tags.contains(element.tagName()))
            log.warn("File " + toRelativePath(file) + " has a deprecated tag <" + element.tagName() + ">");
    }

    public static void hasDeprecatedAttribute(final Logger log, final Config config, final Path file, final Element element) {
        for (final var attribute : element.attributes()) {
    ...
    public static void scriptWithHardcodedNonce(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void styleWithHardcodedNonce(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void labelWithForAttribute(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void inputWithoutMaxLength(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void hasEventHandlerAttribute(final Logger log, final Config config, final Path file, final Element element) {
        for (final var attribute : element.attributes()) {
    ...
    public static void isValidTag(final Logger log, final Config config, final Path file, final Element element) {
    ...
    public static void isValidAttribute(final Logger log, final Config config, final Path file, final Element element) {
        for (final var attribute : element.attributes()) {
